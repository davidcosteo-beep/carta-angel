...
const {
  tablaCartas
} = require('../core/tablaCartas');

const {
  tablaMentor
} = require('../core/tablaMentor');
...
const fontTituloDecorativoBytes =
  fs.readFileSync(
...
const colorLineaMentor =
  mentorData?.colorMentor || "#9333EA";
